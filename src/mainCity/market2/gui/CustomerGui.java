...
import mainCity.market2.interfaces.Customer;
import mainCity.market2.interfaces.CustomerGuiInterface;
...
import role.market2.Market2CustomerRole;
import role.market2.Market2GreeterRole;
...
public class CustomerGui implements Gui, CustomerGuiInterface{
	...
	public CustomerGui(Customer c, Market2AnimationPanel a){ //HostAgent m) {
		this.animation = a;
