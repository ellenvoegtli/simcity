...
import mainCity.market2.interfaces.Employee;
import mainCity.market2.interfaces.EmployeeGuiInterface;
...
public class EmployeeGui implements Gui, EmployeeGuiInterface {
    ...
    public EmployeeGui(Employee agent, Market2AnimationPanel a) {
        this.agent = agent;
        this.animation = a;
