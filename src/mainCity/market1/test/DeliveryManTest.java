...
public class DeliveryManTest extends TestCase {
	...
	public void setUp() throws Exception{
		...
		public void testOneNormalBusinessScenario(){
            ...
            assertTrue("Delivery man should contain a check with the correct ellenCook. It doesn't.",
            		deliveryMan.bills.get(0).getCook() == ellenCook);
		...
		public void testTwoNormalBusinessScenario(){
            ...
            //step 1 - calling it enaRestaurant, but its ellenCook/ellenCashier references will really be for my restaurant
            deliveryMan.msgHereIsOrderForDelivery("mockEllenRestaurant", ellenCook, ellenCashier, inventory, 25.99);
            deliveryMan.msgHereIsOrderForDelivery("mockMarcusRestaurant", otherCook, otherCashier, inventory2, 48.99);
            ...
            assertTrue("Delivery man should contain a check with the correct cook. It doesn't.",
            		deliveryMan.bills.get(1).getCook() == otherCook);
            assertTrue("Delivery man should contain a check with the correct cshier. It doesn't.",
                    deliveryMan.bills.get(1).getCashier() == otherCashier);
            assertTrue("Delivery man should contain a check with the right restaurant in it. It doesn't.", 
