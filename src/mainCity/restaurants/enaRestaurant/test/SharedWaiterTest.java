...
import mainCity.restaurants.enaRestaurant.test.mock.MockCashier;
...
public class SharedWaiterTest extends TestCase{
	...
	EnaSharedWaiterRole sharedWaiter;
	...
	public void setUp() throws Exception{
		...
		sharedWaiter = new EnaSharedWaiterRole(base, base.getName());
	...
	public void testOneNormalCustomerScenario() {
		...
		assertEquals("Waiter should have one customer in its list. It doesn't.", sharedWaiter.MyCust.size(), 0);
		...
		assertEquals("Waiter should have one customer in its list. It doesn't.", sharedWaiter.MyCust.size(), 1);
