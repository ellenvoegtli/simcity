package enaRestaurant.test;

import enaRestaurant.test.mock.MockCustomer;
import enaRestaurant.test.mock.MockMarket;
import enaRestaurant.test.mock.MockWaiter;
import enaRestaurant.CashierRole;
import enaRestaurant.CashierRole.Tab;
import enaRestaurant.CashierRole.marketPay;
...
//step 2 of the test
			...
			cashier.msgPayment("salad", 5.99, customer);
...
//check postConditions for step 2/ preconditions for step 3
			...
			assertTrue("Cashier's tab should contain a bill of $5.99.It contains something else instead: $ " + cashier.Tabs.get(0).getPrice("salad"), cashier.Tabs.get(0).getPrice("salad") == 5.99);
...
//step 2 of the test
		...
		cashier.msgPayment("salad", 5.99, customer2);
...
public void testFiveScenerio()
{
	...
	//step 1 of the test
			...
			cashier.msgComputeBill("salad", customer3);//send the message from a waiter
...
//check postconditions for step 1 and preconditions for step 2
	...
	//step 2 of the test	
			...
			cashier.msgPayment("salad", 5.99, customer3);
...
//check postConditions for step 2/ preconditions for step 3
			...
			assertTrue("Cashier's tab should contain a bill of $5.99.It contains something else instead: $ " + cashier.Tabs.get(1).getPrice("salad"), cashier.Tabs.get(1).getPrice("salad") == 5.99);
			assertTrue("Cashier tab should contain a tab with state == paid. It doesn't.", cashier.Tabs.get(0).paymentStat == payStatus.paid);
...
//step 2 of the test
	...
	//check postConditions for step 2/ preconditions for step 3
				...
				assertTrue("CashierTab should contain a tab with the right customer in it. It doesn't.", cashier.Tabs.get(0).c == customer);
				assertTrue("Cashier's tab should contain a bill of $5.99.It contains something else instead: $ " + cashier.Tabs.get(0).getPrice("salad"), cashier.Tabs.get(0).getPrice("salad") == 5.99);
				assertTrue("Cashier's market should contain a bill.It contains something else instead: $ " + cashier.Tabs.get(0).getPrice("salad"), cashier.Tabs.get(0).getPrice("salad") == 5.99);
